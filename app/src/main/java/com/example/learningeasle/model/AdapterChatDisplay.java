...
public class AdapterChatDisplay extends RecyclerView.Adapter<AdapterChatDisplay.UserHolder> {
    Context context;
    List<ModelUsers> userList;


    public AdapterChatDisplay(Context context, List<ModelUsers> userList) {
...
//          System.out.println(userName+" jsr "+email);
    ...
    private void setFollower(final AdapterChatDisplay.UserHolder holder, final String curruid, final String uid) {
        final DatabaseReference reffollowing = FirebaseDatabase.getInstance().getReference("Users")
                .child(curruid);
